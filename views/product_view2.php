                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                ...
                                <h3><b><?php echo number_format($prodObj->price, 2); ?></b> <small>บาท</small></h3>
                                <hr />
                                <div class="row mt-3">
                                    <div class="col-lg-3 mt-1">
                                        <span class="mx-auto" style="font-size: 15px;">ประเภท</span>
                                    </div>
                                    <div class="col-lg-9 mb-3">
                                        <select class="custom-select mr-sm-2 border-0 shadow-sm" id="inlineFormCustomSelect">
                                            <option selected>โปรดเลือกประเภท (ร้อน, เย็น, ปั่น)</option>
                                            <option>ร้อน (35 บาท)</option>
                                            <option>เย็น (40 บาท)</option>
                                            <option>ปั่น (45 บาท)</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-3 mt-1">
                                        <span class="mx-auto" style="font-size: 15px;">ความหวาน</span>
                                    </div>
                                    <div class="col-lg-9 mb-3">
                                        <select class="custom-select mr-sm-2 border-0 shadow-sm" id="inlineFormCustomSelect">
