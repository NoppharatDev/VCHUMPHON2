...
<div style="background-color: #FFF;">
    <div class="container pt-5">
        ...
        <p class="mb-2">นอกจากสามสถานที่นี้แล้ว ยังมีแหล่ง<a class="text-premium" href="s://vchumphon.com/travel">ท่องเที่ยวชุมพร</a>ให้ชื่นชมอีกมากมาย รวมไปถึงหมู่เกาะต่างๆ ที่อยู่ใกล้ๆ ด้วย นับว่าเป็นจังหวัดที่เที่ยวได้อย่างสนุกสนานมาก</p>
        <h3 style="color: #CF952A; font-weight: 800; font-size: 20px;">3. ชุมพรเป็นแหล่งปลูกกาแฟสำคัญของไทย</h3>
        <p class="mb-2">หลายท่านอาจจะไม่ทราบ แต่เมืองชุมพรนั้นเป็น<a class="text-premium" href="s://vchumphon.com">สวนกาแฟ</a>ที่สำคัญของประเทศไทย ซึ่งมีสภาพแวดล้อมและภูมิอากาศที่เหมาะกับการปลูกกาแฟโรบัสต้าอย่างมาก เพราะกาแฟสายพันธุ์นี้ชื่นชอบ พื้นที่ต่ำ อากาศชื้น ปลูกง่าย และสามารถทนต่อโรคต่างๆ</p>
        <p class="mb-2">ได้ดี ทำให้เกิดกาแฟโรบัสต้าไทย ที่ถูกยอมรับไปทั่วโลกและได้ส่งออกไปยังประเทศแถบยุโรป อเมริกา ญี่ปุ่น ฯลฯ สวน<a class="text-premium" href="s://vchumphon.com">กาแฟชุมพร</a>จึงเป็นอีกหนึ่งเหตุผลที่คุณไม่ควรพลาดที่จะมาท่องเที่ยวในจังหวัดนี้ ซึ่งรับรองว่าต้องถูกใจคอกาแฟอย่างแน่นอน</p>
