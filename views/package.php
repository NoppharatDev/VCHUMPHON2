...
<div style="background-color: #FFF;">
    <div class="container pt-5">
        ...
        <h2 style="color: #CF952A; font-weight: 800; font-size: 20px;">1. ชุมพรเป็นเมืองสำคัญทางประวัติศาสตร์ไทย</h2>
        ...
        <h2 style="color: #CF952A; font-weight: 800; font-size: 20px;">2. ท่องเที่ยวชุมพรสวยงามและหลากหลาย</h2>
        ...
        <h2 style="color: #CF952A; font-weight: 800; font-size: 20px;">3. ชุมพรเป็นแหล่งปลูกกาแฟสำคัญของไทย</h2>
