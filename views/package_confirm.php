                    ...
                    <form class="row" action="" method="POST">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg br-20" id="first_name" name="first_name">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="last_name" class="mb-0">นามสกุล <b><sup class="text-danger">*</sup></b></label>
                                <input type="text" class="form-control form-control-lg br-20" id="last_name" name="last_name">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="phone" class="mb-0">เบอร์โทรศัพท์ <b><sup class="text-danger">*</sup></b></label>
                                <input type="text" class="form-control form-control-lg br-20" id="phone" name="phone">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="email" class="mb-0">อีเมล <b><sup class="text-danger">*</sup></b></label>
                                <input type="email" class="form-control form-control-lg br-20" id="email" name="email">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="province" class="mb-0">จังหวัด <b><sup class="text-danger">*</sup></b></label>
                                <input type="text" class="form-control form-control-lg br-20" id="province" name="province">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="zipcode" class="mb-0">รหัสไปรษณีย์ <b><sup class="text-danger">*</sup></b></label>
                                <input type="text" class="form-control form-control-lg br-20" id="zipcode" name="zipcode">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="fname" class="mb-0">วันที่เริ่มท่องเที่ยว <b><sup class="text-danger">*</sup></b></label>
                                <input type="date" class="form-control form-control-lg br-20" id="fname" >
                            </div>
                            <div class="form-group">
                                <label for="adult" class="mb-0">จำนวนผู้ใหญ่ (<?php echo $pkgObj->adult_price; ?> / คน) <b><sup class="text-danger">*</sup></b></label>
                                <select class="form-control form-control-lg br-20" id="adult" name="adult">
                                    <option>0</option>
                                <?php
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="fname" class="mb-0">คำถาม / ความคิดเห็น</label>
                                <textarea class="form-control form-control-lg br-20" rows="5"></textarea>
                            </div>
                            ...
                            <button type="submit" name="submit" class="btn btn-warning btn-premium btn-lg border-0 br-20 px-5">ยืนยันการจอง</button>
                        </div>
                    </form>
                </div>
            </div>
